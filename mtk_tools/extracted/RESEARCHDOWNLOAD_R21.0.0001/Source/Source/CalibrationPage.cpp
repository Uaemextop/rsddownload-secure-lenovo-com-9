...
// So SPUpgrade must be initialized by configure
	...
	m_bBackupProdnvMiscdata = ::GetPrivateProfileInt( _T("Options"), _T("BackupProdnvMiscData"), FALSE, pFileName );
#endif
