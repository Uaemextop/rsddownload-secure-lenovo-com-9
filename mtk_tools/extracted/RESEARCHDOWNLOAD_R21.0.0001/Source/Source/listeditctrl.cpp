...
CListEditCtrl::CListEditCtrl(int iItem, int iSubItem, const CString &sInitText):m_strInitText(sInitText)
{	
	m_iItem = iItem;
	m_iSubItem = iSubItem;
	m_bVK_ESCAPE = 0;
...
{	
	...
	lvDispInfo.item.pszText = m_bVK_ESCAPE ? NULL : const_cast<LPTSTR>(str.operator LPCTSTR());
